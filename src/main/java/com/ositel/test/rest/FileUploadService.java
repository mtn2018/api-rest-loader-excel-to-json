...
public class FileUploadService {
    ...
    @Autowired
    EmployeeRepository fileUploadDao;
   ...
   EmployeeRepository employeeRepository;
    ...
    public String uploadFileData(String inputFilePath){
        ...
        try
        {
            ...
            ArrayList<ExelFile> ef = new ArrayList<>();
            ...
            while(rowIterator.hasNext())
            {
                ...
                Employee excelTemplateVO = new Employee();
                int count=0;
                while(count<headerNames.length){
                    ...
                    setValueIntoObject(excelTemplateVO, Employee.class, methodName, "java.lang.String", inputCellValue);
                }
